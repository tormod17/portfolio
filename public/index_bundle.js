...
var _CSSTransitionGroup = __webpack_require__(38);

var _CSSTransitionGroup2 = _interopRequireDefault(_CSSTransitionGroup);

var _TransitionGroup = __webpack_require__(21);
...
var _registerServiceWorker = __webpack_require__(60);
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(12),A=__webpack_require__(4),B=__webpack_require__(2),ca=__webpack_require__(13),da=__webpack_require__(14),ea=__webpack_require__(15),ha=__webpack_require__(16),ia=__webpack_require__(17),C=__webpack_require__(6);
...
// module
exports.push([module.i, ".Posts img{width:30%}.pageWrapper{margin:0 3em}@media all and (max-width: 570px), all and (max-height: 350px){.pageWrapper{margin:0 1em}}.Form{position:fixed;top:0;left:0;height:100%;width:100%}.Form .form-wrapper{overflow:scroll;height:58vh;width:100%}@media all and (max-width: 570px), all and (max-height: 350px){.Form .form-wrapper{height:70vh}}.Form .form-wrapper form{margin:2em}.overlay{position:fixed;top:0;left:0;height:100%;width:100%;background:rgba(0,0,0,0.7)}.closeButton{position:absolute;top:3px;right:3px;color:grey}.centerPage{background:white;position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;min-height:40vh;max-height:80vh;border-radius:0.5%;-webkit-transition:all 1s ease;transition:all 1s ease}@media all and (max-width: 570px), all and (max-height: 350px){.centerPage{min-height:100%;max-height:100%}}.buttonPair{text-align:right}.buttonPair button{margin:0.5em}.formTrans-appear{opacity:0.01;-webkit-transform:scale(0.5);transform:scale(0.5)}.formTrans-appear.formTrans-appear-active{opacity:1;-webkit-transition:opacity 200ms ease-in;transition:opacity 200ms ease-in;-webkit-transform:scale(1);transform:scale(1);-webkit-transition:all 500ms ease;transition:all 500ms ease}.formTrans-enter.formTrans-enter-active{opacity:1;-webkit-transition:opacity 500ms ease;transition:opacity 500ms ease;-webkit-transform:scale(1);transform:scale(1);-webkit-transition:all 500ms ease;transition:all 500ms ease}.formTrans-leave{opacity:1;-webkit-transform:scale(0.5);transform:scale(0.5);-webkit-transition:all 500ms ease;transition:all 500ms ease}.formTrans-leave.formTrans-leave-active{opacity:0.5;-webkit-transition:opacity 300ms ease-in;transition:opacity 300ms ease-in}.listTrans-enter{opacity:0.01;-webkit-transform:scale(0.5);transform:scale(0.5)}.listTrans-enter.listTrans-enter-active{opacity:1;-webkit-transition:opacity 500ms ease;transition:opacity 500ms ease;-webkit-transform:scale(1);transform:scale(1);-webkit-transition:all 500ms ease;transition:all 500ms ease}.listTrans-leave{opacity:1;-webkit-transform:scale(1);transform:scale(1);-webkit-transition:all 500ms ease;transition:all 500ms ease}.listTrans-leave.listTrans-leave-active{opacity:0.01;-webkit-transform:scale(0.5);transform:scale(0.5);-webkit-transition:all 500ms ease;transition:all 500ms ease}.goBack{position:absolute;right:1em;top:1em}.Menu a{text-decoration:none}.Menu span{display:block}\n", ""]);
...
var _reactTransitionGroup = __webpack_require__(20);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.isAdmin = window.location.href.includes('editing1234');
    _this.showHideForm = _this.showHideForm.bind(_this);
    _this.editForm = _this.editForm.bind(_this);
    _this.getAllPosts = _this.getAllPosts.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function getAllPosts() {
      ...
      fetch('/redis/posts').then(function (res) {
        console.log(res);
        return res.json();
      }).then(function (json) {
        var posts = _extends({}, json);
        _this2.setState({
          posts: posts
        });
      });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'col-xs-6 col-sm-10 center' },
            _react2.default.createElement(
              'div',
              { className: '' },
              _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'col-xs-6 col-sm-2 sideWrapper' },
            _react2.default.createElement(
              'div',
              { className: 'info aside section' },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'col-sm-10 postsWrapper' },
          ...
          _react2.default.createElement(
            'div',
            { className: 'col-sm-2 sideWrapper' },
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            'This blog is a meta React project xxx'
          )
        )
      );
    }
...
var Post = function (_PureComponent) {
  ...
  function Post(props) {
    ...
    _this.deletePost = function (key) {
      var url = '/redis/delete?hash=' + key;
      fetch(url).then(function (res) {
        var e = new Event('posts');
        document.dispatchEvent(e);
      });
    };

    _this.editPost = function (key) {
      _this.props.editForm(key);
    };

    _this.getNewOrderWithExtraFields = function (item) {
      var newOrder = ['title'];
      var itemFields = Object.keys(item);
      var items = itemFields.filter(function (field) {
        return field.match(/\d+/);
      });
      items.sort(function (a, b) {
        return a.slice(-1) - b.slice(-1);
      });
      return ['title'].concat(_toConsumableArray(items));
    };

    _this.formatTextArea = function (text) {
      return _react2.default.createElement(
        'p',
        null,
        text
    ...
    _this.formatList = function (list) {
      ...
      var jsxList = listItems.map(function (item) {
        return _react2.default.createElement(
          'li',
          { key: item },
          item
    ...
    _this.renderTextImages = function (item) {
      var newOrder = _this.getNewOrderWithExtraFields(item);
      return newOrder.map(function (key) {
        var content = void 0;
        switch (true) {
          case key === 'title':
          ...
          case key.includes('text'):
            content = _this.formatTextArea(item[key]);
            break;
          case key.includes('list'):
            content = _this.formatList(item[key]);
            break;
          case key.includes('Image'):
            content = item[key] && _react2.default.createElement('img', { src: item[key], className: 'img-rounded thumbnail' });
            break;
          case key.includes('iframe'):
            content = item[key] && _react2.default.createElement('iframe', { src: item[key], className: 'iframe' });
            break;
...
var Menu = function (_Component) {
  ...
  _createClass(Menu, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'aside',
        { className: 'Menu info aside section' },
        posts && _react2.default.createElement(
          'ul',
          { className: 'list-group' },
...
var _AddForm = __webpack_require__(58);

var _AddForm2 = _interopRequireDefault(_AddForm);

var _EditForm = __webpack_require__(59);
...
var Form = function (_Component) {
  ...
  _createClass(Form, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var editingPost = this.props.editingPost;

      if (editingPost) {
        this.setState(_extends({}, editingPost));
      }
    ...
    value: function render() {
      var _props = this.props,
          ...
          editingPost = _props.editingPost,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('div', { onClick: closeForm, className: 'overlay' }),
        _react2.default.createElement(
          'div',
          { className: 'container centerPage' },
          _react2.default.createElement(
            'div',
            { className: 'page-header' },
            _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            editingPost && _react2.default.createElement(_EditForm2.default, {
              closeForm: closeForm,
              post: editingPost,
              id: editingId
            }),
            !editingPost && _react2.default.createElement(_AddForm2.default, {
              closeForm: closeForm
            })
          )
        )
...
var AddForm = function (_Component) {
  ...
  function AddForm(props) {
    ...
    _this.renderImageTextInput = function (key) {
      var fieldsRequired = ['subTitle', 'Image', 'Iframe', 'text', 'list'];

      var fields = fieldsRequired.map(function (field) {
        return _react2.default.createElement(
          'div',
          ...
          field !== 'text' && _react2.default.createElement('input', {
            type: 'text',
            className: 'form-control',
            name: '' + key.replace('key', field),
            onChange: _this.updateFieldValue
          }),
          field === 'text' && _react2.default.createElement('textarea', {
            name: '' + key.replace('key', field),
            className: 'form-control',
            rows: '3',
            id: 'text',
    ...
    _this.addMoreInput = function (e) {
      e.stopPropagation();
      _this.setState({
        numberOfInputs: _this.state.numberOfInputs += 1
      });
    };

    _this.updateFieldValue = function (e) {
      e.stopPropagation();
      var val = e.target.value;
      var name = e.target.getAttribute('name');
      _this.setState(function (prevState) {
        return _extends({}, prevState, _defineProperty({}, name, val));
      });
    };
  ...
  _createClass(AddForm, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          numberOfInputs = _state.numberOfInputs,
          title = _state.title;
      var _props = this.props,
          closeForm = _props.closeForm,
          editingPost = _props.editingPost;
      ...
      var newNoOfInputs = numberOfInputs;
      var list = [];
      var key = 0;

      repeat(newNoOfInputs)(function () {
        list.push(_this3.renderImageTextInput('key' + key++));
      });

      return _react2.default.createElement(
        'form',
        { className: 'form-horizontal', onSubmit: this.addPost },
        _react2.default.createElement(
          'div',
          { className: 'form-group' },
          _react2.default.createElement(
...
var EditForm = function (_PureComponent) {
  _inherits(EditForm, _PureComponent);
  ...
  _createClass(EditForm, [{
    ...
    value: function render() {
      ...
      var newOrder = this.getNewOrderWithExtraFields(this.state);

      return _react2.default.createElement(
        'form',
        { className: 'form-horizontal', onSubmit: this.editPost },
        newOrder.map(function (key) {
          return _this2.renderPostFields(key);
        }),
        _react2.default.createElement(
          'div',
          { className: 'form-group' },
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.addMore = function () {
    ...
    var arrNumbers = Object.keys(_this3.state).map(function (key) {
      return key.match(/\d+/);
    });
    var nextFieldNumber = Math.max.apply(Math, _toConsumableArray(arrNumbers)) + 1;
    var newFields = (_newFields = {}, _defineProperty(_newFields, 'subTitle' + nextFieldNumber, ''), _defineProperty(_newFields, 'image' + nextFieldNumber, ''), _defineProperty(_newFields, 'text' + nextFieldNumber, ''), _defineProperty(_newFields, 'list' + nextFieldNumber, ''), _newFields);
    _this3.setState(function (prevState) {
      return _extends({}, newFields, prevState);
    });
  };
  ...
  this.editPost = function (e) {
    ...
    var cleanState = Object.keys(state).reduce(function (p, c) {
      if (state[c] !== '') {
        p[c] = state[c];
      }
      return p;
  ...
  this.renderPostFields = function (key) {
    var post = _extends({}, _this3.state);
    ...
    return _react2.default.createElement(
      ...
      !key.includes('text') && _react2.default.createElement('input', {
        type: 'text',
        className: 'form-control',
        name: key,
        onChange: _this3.updateFieldValue,
        value: post[key]
      }),
      key.includes('text') && _react2.default.createElement('textarea', {
        name: key,
        className: 'form-control',
        rows: '3',
        id: 'text',
  ...
  this.getNewOrderWithExtraFields = function (item) {
    var newOrder = ['title'];
    var itemFields = Object.keys(item);
    var items = itemFields.filter(function (field) {
      return field.match(/\d+/);
